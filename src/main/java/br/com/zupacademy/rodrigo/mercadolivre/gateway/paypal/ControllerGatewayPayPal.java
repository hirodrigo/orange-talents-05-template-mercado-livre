...
@RestController
public class ControllerGatewayPayPal {
	...
	@PostMapping(path = { "retorno-paypal/{idCompra}" })
	@Transactional
	private ResponseEntity<?> cadastrarTransacao(@PathVariable Long idCompra,
			@RequestBody @Valid TransacaoPayPalRequest request, UriComponentsBuilder ucb) throws BindException {
