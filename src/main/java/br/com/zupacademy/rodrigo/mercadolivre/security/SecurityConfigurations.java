...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private UserDetailsServiceImp usersService;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.and().addFilterBefore(new AutenticacaoViaTokenFilter(tokenManager, usersService), UsernamePasswordAuthenticationFilter.class);
	}
}
